...
export default function CustomSearchBox() {
  ...
  return (
    <form
      action=""
      role="search"
      className="border-body-color dark:border-body-color-2 sticky top-0 z-999 rounded-t-xl border-b dark:bg-black"
    >
      <div className="relative">
        ...
        />
        <span
          className="absolute left-0 top-0 flex h-[74px] w-[52px] items-center justify-center text-black dark:text-white">
          <svg
            width="20"
            height="20"
            viewBox="0 0 20 20"
