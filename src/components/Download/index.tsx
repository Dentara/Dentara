...
import DownloadImages from "@/components/Download/DownloadImages";
              ...
              <SlideOnReveal delay={0.3}>
                ...
                >
                  ...
                  <p className="text-body-color-2 dark:text-body-color mb-10 text-lg font-medium">
                    ...
                    lacinia orci, et pretium quam mi a eros sed molestie est.
                  </p>
                  ...
                  <div className="-mx-3 flex items-center">
                    <div className="px-3">
                      <Link
                        href="#"
                        className="flex items-center justify-center rounded-full border border-[#2D2947] bg-[#2D2947] p-2.5 pr-5 text-base font-semibold text-white hover:bg-[#2D2947]/90 dark:hover:bg-[#2D2947]/90"
                      >
                    ...
                    <div className="px-3">
                      <Link
                        href="#"
                        className="text-body-color-2 flex items-center justify-center rounded-full border border-[#2D2947] bg-transparent p-[10px] pr-5 text-base font-semibold hover:bg-[#2D294710] dark:text-white dark:hover:bg-[#2D2947]"
                      >
                        <span className="bg-dark dark:text-dark mr-3 flex h-10 w-10 items-center justify-center rounded-full text-white dark:bg-white">
                          <svg
                            width="24"
                            height="24"
                            viewBox="0 0 24 24"
