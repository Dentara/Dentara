...
export default function DentistForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-900 rounded-xl shadow p-6 space-y-4">
      <h2 className="text-xl font-semibold">Dentist Registration</h2>
      ...
      <input name="idFile" type="file" accept=".jpg,.jpeg,.png,.pdf" className="w-full border p-2 rounded" required />
      <label className="block text-sm font-medium">Upload Diploma</label>
      <input name="diplomaFile" type="file" accept=".jpg,.jpeg,.png,.pdf" className="w-full border p-2 rounded" required />
      <label className="block text-sm font-medium">Upload Selfie Holding Diploma</label>
      <input name="selfieFile" type="file" accept=".jpg,.jpeg,.png" className="w-full border p-2 rounded" required />
