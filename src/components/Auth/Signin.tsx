              ...
              <SlideOnReveal delay={0.3}>
                <div className="wow fadeInUp dark:bg-dark mx-auto max-w-[500px] rounded-md border border-[#f5f5f5] bg-white p-12 sm:p-[60px] dark:border-0">
                  ...
                  <div className="border-body-color/50 mx-auto mb-12 flex flex-col items-center justify-center gap-1 rounded-lg border p-1 md:flex-row">
                    <button
                      className={`text-body-color hover:border-primary hover:bg-primary/5 hover:text-primary dark:hover:border-primary dark:hover:bg-primary/5 dark:hover:text-primary w-full rounded-lg px-6 py-3 text-base outline-hidden transition-all duration-300 dark:border-transparent dark:bg-[#2C303B] dark:hover:shadow-none ${
                        !isPassword &&
                    ...
                    <div className="mb-8 flex items-center justify-between">
                      <div>
                        ...
                        >
                          ...
                          />
                          <div className="border-body-color/30 mr-4 flex h-5 w-5 items-center justify-center rounded-sm border dark:border-white/10">
                            {data?.remember && (
                              <span>
                                <svg
                                  width="11"
