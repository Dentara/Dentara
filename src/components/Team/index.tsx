...
const Team = () => {
  return (
    <>
      <section
        id="team"
        className="border-t border-[#F3F4F4] pb-20 pt-[120px] dark:border-[#2D2C4A]"
      >
          ...
          <div className="-mx-4 flex flex-wrap">
            {teamData.map((item, index) => (
              <div key={index} className="w-full px-4 sm:w-1/2 lg:w-1/4">
                <SlideOnReveal delay={0.3}>
                  <div
                    className="wow fadeInUp group mb-10 rounded-lg border-b-4 border-transparent bg-light-bg p-4 text-center transition-all hover:border-primary dark:bg-dark"
                    data-wow-delay="0s"
                  >
